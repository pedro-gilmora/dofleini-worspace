...
svg.nml-12(
  ...
  defs
    clippath#a
      rect.a(width="807", height="598", transform="translate(1093 225)")
    filter#b(
      x="135",
      y="34",
      width="830",
    ...
    clippath#d
      rect.b(width="680", height="452", transform="translate(3689 642)")
    filter#e(
      x="276",
      y="273",
      width="573",
  ...
  g.d(transform="translate(-1093 -225)")
    g(transform="translate(1321.7 224.819)")
      ...
      g.h(transform="translate(210.099 26.108)")
        circle.af(cx="3.502", cy="3.502", r="3.502")
        circle.ac(cx="3.502", cy="3.502", r="3.002")
    g(transform="translate(1175.7 502.819)")
      ...
      g.h(transform="translate(0 106.145)")
        circle.af(cx="3.502", cy="3.502", r="3.502")
        circle.ac(cx="3.502", cy="3.502", r="3.002")
      g.h(transform="translate(46.022 184.182)")
        circle.af(cx="3.502", cy="3.502", r="3.502")
        circle.ac(cx="3.502", cy="3.502", r="3.002")
    g(transform="translate(-2386 -340)")
      g.al(transform="matrix(1, 0, 0, 1, 3479, 565)")
        path.k(
          d="M5,0H680a0,0,0,0,1,0,0V447a5,5,0,0,1-5,5H5a5,5,0,0,1-5-5V5A5,5,0,0,1,5,0Z",
          transform="translate(210 77)"
        )
      g.l
        g.b(transform="translate(3689 717)")
          rect.af(width="688", height="377")
          rect.ac(x="0.5", y="0.5", width="687", height="376")
        g.m(transform="translate(3767 688)")
          rect.af(width="626", height="24", rx="12")
          rect.ac(x="0.5", y="0.5", width="625", height="23", rx="11.5")
      g(transform="translate(-28 -11)")
        rect.n(width="8", height="46", transform="translate(3781 849)")
        rect.n(width="8", height="46", transform="translate(3781 896)")
        rect.n(width="8", height="46", transform="translate(3781 990)")
        rect.n(width="8", height="46", transform="translate(3781 1037)")
        g.ak(transform="matrix(1, 0, 0, 1, 3507, 576)")
          rect.c(width="573", height="45", transform="translate(276 273)")
        g.aj(transform="matrix(1, 0, 0, 1, 3507, 576)")
          rect.c(width="573", height="45", transform="translate(276 320)")
        g.ai(transform="matrix(1, 0, 0, 1, 3507, 576)")
          rect.o(width="573", height="45", transform="translate(276 367)")
        g.ah(transform="matrix(1, 0, 0, 1, 3507, 576)")
          rect.c(width="573", height="45", transform="translate(276 414)")
        g.ag(transform="matrix(1, 0, 0, 1, 3507, 576)")
          rect.c(width="573", height="45", transform="translate(276 461)")
        rect.p(width="177", height="45", transform="translate(4119 849)")
        rect.p(width="177", height="45", transform="translate(4119 896)")
        rect.q(width="177", height="45", transform="translate(4119 943)")
        rect.p(width="177", height="45", transform="translate(4119 990)")
        rect.p(width="177", height="45", transform="translate(4119 1037)")
        rect.r(
          width="145",
          height="19",
          rx="9.5",
        ...
        rect.s(width="6", height="46", transform="translate(3781 943)")
      path.t(
        d="M5,0H680a0,0,0,0,1,0,0V42a0,0,0,0,1,0,0H0a0,0,0,0,1,0,0V5A5,5,0,0,1,5,0Z",
        transform="translate(3689 642)"
      )
      rect.u(width="680", height="1", transform="translate(3689 716)")
      path.k(
      ...
      text.v(transform="translate(3791.538 705.215)")
        tspan(x="0", y="0") Secure
      text.v(transform="translate(3850.538 705.215)")
        tspan(x="0", y="0") https:
      ...
      g.y
        g(transform="translate(3689 716)")
          g.b
            rect.af(width="49", height="378")
            rect.ac(x="0.5", y="0.5", width="48", height="377")
          rect.z(width="34", height="37", rx="3", transform="translate(7 90)")
        ...
        g(transform="translate(3737 716)")
          g.b
            rect.af(width="589", height="56")
            rect.ac(x="0.5", y="0.5", width="588", height="55")
          rect.s(
            width="119",
            height="32",
            rx="16",
      ...
      g(transform="translate(3740 693)")
        path.ac(d="M0,0H14.931V14.931H0Z")
        path(
      ...
      g(transform="translate(3924.893 658.524)")
        path.ac(d="M0,0H17.583V17.583H0Z")
        path(
      ...
      g(transform="translate(3776 693.857)")
        path.ac(d="M0,0H12.794V12.794H0Z")
        path.ae(
...
<style scoped>
svg {
  width: 60%; position: fixed;right: 16px;z-index: -1;
}
@media (max-width: 992px){
  svg {
    width: 100%; position: relative;right: 0;z-index: 1;
  }
}
.a,
.b,
...
@Component
export default class WorspacePreview extends Vue {
  @Prop()
  domain!: string;
